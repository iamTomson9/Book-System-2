...
import javafx.scene.control.TableColumn; // Add import statement for TableColumn
...
public class BookwormHaven extends Application {
    ...
    new Image("file:///C:/JAVA/Princess/Princess/bg.jpg", 800, 600, false, true),
    ...
    BackgroundSize.DEFAULT
        ...
        layout.setStyle("-fx-text-fill: #FFFFFF;");
